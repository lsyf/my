...
function queryData() {
    ...
    $.ajax({
        type: "POST",
        url: hostUrl + "rptQueryCust2017/list",
        timeout: 30000,
        data: {
...
function exportData(isMulti, btn) {
    ...
    form.attr('action', hostUrl + 'rptQueryCust2017/export');
    form.empty();
...
function listAudit(type, btn) {
    $.ajax({
        type: "POST",
        url: hostUrl + "rptQueryCust2017/listAudit",
        data: {
            month: $("#form_month").val(),
            latnId: orgTree.val(),
            incomeSource: isTree.val(),
...
function auditData(rptCaseId, status) {
    $.ajax({
        type: "POST",
        url: hostUrl + "rptQueryCust2017/audit",
        data: {
            rptCaseId: rptCaseId,
            status: status,
